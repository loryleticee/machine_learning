...
url = 'https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/Prediction/dd16eece-19b1-4089-8b48-5f687c5fb141/classify/iterations/Iteration1/image'
api_keys = 'd143a0b62dfb43bb81cb9c8b71968666'
...
def take_trash_picture():
    ...
    return open(dir_+path,"rb"), '/'+dir_+path
